...
public class Blocks
{
	...
	public static final RegistryObject<Block> YELLOW_TULIP_POTTED = registerWithoutBlockItem("potted_yellow_tulip", () -> new FlowerPotBlock(() -> ((FlowerPotBlock) net.minecraft.world.level.block.Blocks.FLOWER_POT), Blocks.YELLOW_TULIP, BlockBehaviour.Properties.copy(net.minecraft.world.level.block.Blocks.POTTED_RED_TULIP).noOcclusion()));
	...
	public static final RegistryObject<Block> PURPLE_TULIP_POTTED = registerWithoutBlockItem("potted_purple_tulip", () -> new FlowerPotBlock(() -> ((FlowerPotBlock) net.minecraft.world.level.block.Blocks.FLOWER_POT), Blocks.PURPLE_TULIP, BlockBehaviour.Properties.copy(net.minecraft.world.level.block.Blocks.POTTED_RED_TULIP).noOcclusion()));
	...
	public static final RegistryObject<Block> BLACK_TULIP_POTTED = registerWithoutBlockItem("potted_black_tulip", () -> new FlowerPotBlock(() -> ((FlowerPotBlock) net.minecraft.world.level.block.Blocks.FLOWER_POT), Blocks.BLACK_TULIP, BlockBehaviour.Properties.copy(net.minecraft.world.level.block.Blocks.POTTED_RED_TULIP).noOcclusion()));
	...
	public static final RegistryObject<Block> CYAN_POPPY_POTTED = registerWithoutBlockItem("potted_cyan_poppy", () -> new FlowerPotBlock(() -> ((FlowerPotBlock) net.minecraft.world.level.block.Blocks.FLOWER_POT), Blocks.CYAN_POPPY, BlockBehaviour.Properties.copy(net.minecraft.world.level.block.Blocks.POTTED_POPPY).noOcclusion()));
